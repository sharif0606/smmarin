                                        ...
                                        <ul class="facet_filter_box facet_manufacturer">
                                            <li class="facet_filter_item_li">
                                                <label class="facet-label checkbox-inline">
                                                    ...
                                                    <a href="" class="_gray-darker search-link" rel="nofollow">
                                                        Danelec
                                            ...
                                            <li class="facet_filter_item_li">
                                                <label class="facet-label checkbox-inline" for="facet_input_50077_3">
                                                    <span class="custom-input-box">
                                                        <input type="checkbox" class="custom-input" />
                                                        <span class="custom-input-item custom-input-checkbox"></span>
                                                    </span>
                                            ...
                                            <li class="facet_filter_item_li">
                                                <label class="facet-label checkbox-inline" for="facet_input_50077_4">
                                                    <span class="custom-input-box">
                                                        <input type="checkbox" class="custom-input" />
                                                        <span class="custom-input-item custom-input-checkbox"></span>
                                                    </span>
                                    ...
                                    <div class="pro_second_box pro_block_align_0">
                                        <div class="mini_name">
                                            <h3 class="s_title_block two_rows">
                                                <a href="<?= base_url()."product-view/".$abd->category_name."/".$abd->news_name."/".$abd->news_id."/".$abd->fk_news_id;?>" class="product_img_link"><?= base_url().$abd->news_name;?></a>
                                            </h3>
                                        </div>
